...
| Scene/state stack (M20) | [`crates/tungsten/src/state.rs`](../crates/tungsten/src/state.rs), [`crates/tungsten-core/src/assets/scene.rs`](../crates/tungsten-core/src/assets/scene.rs), [`crates/tungsten/src/asset_loader.rs`](../crates/tungsten/src/asset_loader.rs), [`examples/04_scene_state/`](../examples/04_scene_state/) |
...
| Work inside the component-sprites example | [`examples/03_component_sprites/src/main.rs`](../examples/03_component_sprites/src/main.rs), [`crates/tungsten/src/sprite_extract.rs`](../crates/tungsten/src/sprite_extract.rs), [`crates/tungsten-core/src/components.rs`](../crates/tungsten-core/src/components.rs) |
| Change state transitions, scene spawn, or SceneEntity cleanup | [`crates/tungsten/src/state.rs`](../crates/tungsten/src/state.rs), [`crates/tungsten/src/asset_loader.rs`](../crates/tungsten/src/asset_loader.rs), [`crates/tungsten-core/src/assets/scene.rs`](../crates/tungsten-core/src/assets/scene.rs), [`examples/04_scene_state/src/states.rs`](../examples/04_scene_state/src/states.rs), [`docs/DECISION_INDEX.md`](DECISION_INDEX.md) for `D-046` |
