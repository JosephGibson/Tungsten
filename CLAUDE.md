...
Workspace `v0.28.0` on branch `0.26`. Phase 3 is complete; all milestones `M12`–`M24` shipped and the rollout plan is archived at [`docs/plans/archive/phase3.md`](docs/plans/archive/phase3.md). Phase 4 is underway with M25, M26, M27, M28, and M29 shipped; remaining scope is tracked in [`docs/plans/phase4.md`](docs/plans/phase4.md). Performance follow-up work is tracked in [`docs/plans/perf-overhead-audit.md`](docs/plans/perf-overhead-audit.md).
